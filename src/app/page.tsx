...
const testimonials = [
  ...
  },
  {
    ...
    quote: 'We received our visas! I consulted Global Consulting & Visa Hub for my J-1 visa and our children\'s dependent visas. It was a stressful and complex process, but the team managed everything perfectly — from documentation to interview preparation.',
    rating: 5,
  },
  {
    name: 'Vindya Sakuni',
    visaType: 'F-1 & F-2 Visa',
    quote: 'I strongly recommend Global Consulting & Visa Hub for F1 and F2 visa guidance. The team is easy to communicate with and informs us of all the procedures A to Z. They prepare us well with all the documents and nothing to worry about.',
    rating: 5,
  },
  {
    name: 'Tharinda Vimukthi',
    visaType: 'USA Immigration',
    quote: 'I highly recommend this page for everyone willing to migrate to Americas. As a student, as an individual, as a tourist, as a family—you can get all detailed information and advice. The consultants are nice and friendly.',
    rating: 5,
  },
];
