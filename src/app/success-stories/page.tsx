...
const successStories = [
    {
        ...
        country: 'Sri Lanka',
        story: 'My dream of studying in America came true! With expert guidance, I secured an $11,000 scholarship and my F-1 visa was approved on the first attempt. The entire process was handled professionally, from university selection to interview preparation. I am now pursuing my degree in Louisiana and couldn\'t be happier with the support I received.',
        fullStory: 'When I first decided to pursue higher education in the United States, I was overwhelmed by the complex visa process. I had heard many stories of visa rejections and was quite nervous. That\'s when I discovered Global Consulting & Visa Hub. From our very first consultation, I knew I was in good hands. The team helped me identify universities that matched my academic profile and career goals. They guided me through the entire application process, and I was thrilled to receive an acceptance letter from Louisiana State University along with an $11,000 scholarship! The interview preparation was thorough and comprehensive. We practiced multiple scenarios, and I felt confident walking into the embassy. When the officer stamped my passport with the F-1 visa, I couldn\'t contain my joy. Today, I\'m living my American dream, and I owe it all to the excellent guidance I received.',
    ...
    },
    {
        ...
        purpose: 'Exchange Program',
        country: 'Sri Lanka',
        story: 'Received J-1 exchange visitor visa for cultural exchange program in the US. Professional guidance helped navigate the complex application process successfully.',
        fullStory: 'Participating in a cultural exchange program in the United States required obtaining a J-1 exchange visitor visa. The application process involved sponsor organization approval, DS-2019 documentation, and comprehensive visa interview preparation. Professional consulting support helped organize all required documents, including program details, financial documentation, and proof of ties to home country. Interview preparation focused on clearly explaining the exchange program objectives, cultural exchange goals, and plans to return home after program completion. Mock interview sessions helped build confidence in articulating program details and answering questions about the exchange opportunity. The thorough preparation and well-organized documentation led to visa approval, enabling participation in this valuable cultural exchange experience.',
        visaImage: '/images/granted visa/Chameera Madhuranga.png',
    },
    {
        id: 9,
        name: 'Nethumsa Methsuvi',
        visaType: 'J-2' as const,
        appliedDate: 'Sep 2024',
        grantedDate: 'Oct 2024',
        university: '',
        course: '',
        purpose: 'Dependent Visa',
        country: 'Sri Lanka',
        story: 'Successfully obtained J-2 dependent visa to accompany J-1 exchange visitor. The process was smooth with expert document preparation.',
        fullStory: 'Obtaining a J-2 dependent visa to accompany a J-1 exchange visitor required careful documentation and preparation. The process involved proving the relationship, demonstrating financial capability, and showing intent to return home after the exchange program. Professional consulting helped organize all required documents, including marriage certificates, birth certificates, financial statements, and the J-1 visa holder\'s program documentation. The interview preparation focused on understanding the dependent visa requirements and articulating the purpose clearly. With proper guidance and well-organized documentation, the visa was approved smoothly, allowing family members to accompany the exchange visitor to the United States.',
        visaImage: '/images/granted visa/Nethumsa Methsuvi.png',
    },
    {
        id: 10,
        name: 'Ovinma Methsuvi',
        visaType: 'J-2' as const,
        appliedDate: 'Sep 2024',
        grantedDate: 'Oct 2024',
        university: '',
        ...
        purpose: 'Dependent Visa',
        country: 'Sri Lanka',
        story: 'Approved for J-2 dependent visa to join family in the United States. Professional support made the entire application process straightforward.',
        fullStory: 'Joining a family member participating in a J-1 exchange program required obtaining a J-2 dependent visa. The application process involved gathering proof of relationship, financial documentation, and supporting evidence for the principal J-1 visa holder. Expert consulting support helped streamline document collection and ensured all requirements were met accurately. The interview preparation included understanding typical questions about the purpose of accompanying the exchange visitor and family ties. Clear guidance on presenting documents and answering questions confidently contributed to a successful outcome. The visa approval came through smoothly, allowing for family reunification during the exchange program period.',
        visaImage: '/images/granted visa/Ovinma Methsuvi.png',
    },
    {
        id: 11,
        name: 'Thejan Nipuna',
        visaType: 'C1/D' as const,
        appliedDate: 'Aug 2024',
        grantedDate: 'Sep 2024',
        university: '',
        course: '',
        purpose: 'Crew Member Visa',
        country: 'Sri Lanka',
        story: 'Secured C1/D crew member visa for working on international vessels. Expert interview preparation and document guidance led to first-attempt approval.',
